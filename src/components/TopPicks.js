...
const TopPicks = ()=>{
    return(
        <div>
            ...
            <div className="hidden lg:flex mx-w-[1920px] m-auto py-2 px-2 ">
                        ...
                        return(
                            ...
                            <div className="rounded-3xl relative">
                                <div className="absolute w-full h-full bg-black/50 rounded-3xl text-white">
                                    ...
                                    <button className="border-dotted border-white text-white mx-2 absolute bottom-4">Ad To Cart</button>
                                </div>
